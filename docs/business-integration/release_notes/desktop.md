...
> Release notes and download links for the desktop version of MetaPerson Creator, the embeddable selfie-to-3D-avatar builder for integration into your app.
...
**Release notes**:
  ...
  * Reduced the number of feedback surveys
