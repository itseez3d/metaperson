# JavaScript API for the 3D Avatar Creator iframe
...
The `avatarCode` can be obtained from the [`model_generated`](#model-generated) and [`model_exported`](#model-exported) events.
