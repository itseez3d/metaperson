...
* `skipViewerControls` - a list of controls that are hidden during customization of the avatar. Available values: `'outfits','hairstyles','glasses','earrings','necklaces','age','body','head','eyes','color','animations','facial_animations','lighting'`.
