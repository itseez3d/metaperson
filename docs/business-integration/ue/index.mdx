...
sidebar_position: 5
description: "Integrate MetaPerson Creator into your Unreal Engine project — create, customize and load selfie-based 3D avatars at runtime with the official UE plugin."
---
