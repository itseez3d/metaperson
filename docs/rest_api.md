...
MetaPerson Creator provides ready-to-use customer-facing solutions with low-code integration into your application. However, there might be conditions, where you have to go with a completely different approach. Like you have strict requirements on the application UI, or you have a platform not yet supported. In this case, you will need to use the REST API for MetaPerson avatars. With the REST API, you can do anything MetaPerson Creator does with your exact requirements and even a little bit more. It may require more effort in the development, however.
